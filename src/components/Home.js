// The landing page: greets the user and shows Login/Register or Logout based on status.
...
function Home() {
  ...
  useEffect(() => {
    // When the page loads, see if the user is already logged in
  ...
  const handleLogout = () => {
    // Log the user out by removing their saved info
