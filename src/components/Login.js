// The login form: lets a user enter details and sign in using the mock service.
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Ask our mock service to "log in" the user
      const data = await authService.login({ username, email, password });
      
      if (data.success) {
        // Save a token and user details so other pages know we are logged in
